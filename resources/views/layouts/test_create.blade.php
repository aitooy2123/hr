        ...
        <div class="card-body">
          ...
          <form action="{{ route('test.insert') }}" method="POST">
            ...
            <div class="form-group row">
              ...
              <div class="col-md-10">
                <input type="text" class="form-control col-3" name="fname" value="{{ old('fname') }}" placeholder="ระบุชื่อ">
              </div>
            </div>
            ...
            <div class="form-group row">
              ...
              <div class="col-md-10">
                <input type="text" class="form-control col-3" name="lname" value="{{ old('lname') }}" placeholder="ระบุชื่อ">
              </div>
            </div>
